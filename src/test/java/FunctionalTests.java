...
public class FunctionalTests {
    ...
    public void testYesNoQuestion() {
        ...
        YesNoQuestion yesNoQuestion = new YesNoQuestion("Czy uważasz studia magisterskie za obowiązkowe?");

        // Testowanie funkcji pytania
        assertEquals("Czy uważasz studia magisterskie za obowiązkowe?", yesNoQuestion.getQuestionText());
        ...
        assertEquals("Czy uważasz studia magisterskie za obowiązkowe? (Odpowiedz 'tak' lub 'nie')\n", outputStreamCaptor.toString());
    }
